        ...
        <div className='container  pt-2 pb-20 flex flex-col md:flex-row text-green-400 items-center '>
            <div className='md:w-1/2  w-full h-full border-l-2 border-b-2 rounded-s-xl pl-10 tracking-widest pt-10  pb-5 mt-0 md:mt-16 relative' >
                ...
                <div className='space-y-8  z-20' data-aos="fade-right" data-aos-duration="2000">
                    <div className=''>
                        <h1 className='text-2xl font-extrabold capitalize font-mono leading-relaxed text-white '>Hi there, </h1>
                        <p className='text-xl font-extrabold capitalize leading-relaxed text-white  '>I&apos;m mohamed haddaoui </p>
                        <p className='text-xl font-extrabold capitalize leading-relaxed text-white'>And I&apos;m</p>
                        <MessageWriter />
                    </div>
                    <div className='flex flex-col xl:flex-row  gap-6 text-white'>
                        <div className='w-1/2 flex flex-col gap-2'>
                            ...
                            <div>
                                <p className=' '>mhaddaou@student.1337.ma</p>
                            </div>
                        ...
                        <div className='w-1/2 flex flex-col gap-2'>
                            ...
                            <div className=''>
                                <Link className=' border-b-2  hover:border-none pb-1 hover:text-lst transition  scale-100 duration-300 ease-in' target='_blank' href="https://github.com/mhaddaou">github.com/mhaddaou</Link>
                            </div>
                        </div>
                    </div>
            ...
            <div className='md:w-1/2 h-full  flex justify-center' data-aos="fade-left" data-aos-duration="2000" >
                <Image className=' scale-90 ' src={mhaddaou} alt='img' />
