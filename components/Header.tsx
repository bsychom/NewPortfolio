...
const Header = () =>{
    return (
        ...
        <Link href="#about" className="links shadow-2xl">About</Link>
                            ...
                            <li data-aos="fade-up" data-aos-duration="2500"> <Link href="#notYet" className="links shadow-2xl">  Projects </Link></li>
                            <li data-aos="fade-up" data-aos-duration="3000"> <Link href="#notYet" className="links shadow-2xl">  Contact </Link></li>
                    ...
                    <div className="dropdown lg:hidden pr-2  dropdown-left cursor-pointer">    
                        ...
                        <ul tabIndex={0}  className="dropdown-content z-[1] menu p-2 font-bold  mr-4 rounded-box w-52 bg-thr text-white shadow-xl shadow-lst ">
                            ...
                            <li>  <Link tabIndex={0} href="#notYet" className="links hover:text-black">  Projects </Link></li>
                            <li>  <Link tabIndex={0} href="#notYet" className="links hover:text-black">  Contact </Link></li>
